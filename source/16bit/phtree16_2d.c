...
static void* add_child (ph2_node_t* node, hypercube_address_t address)
{
...
static void node_add_entry (ph2_node_t* node, ph2_point_t* point)
{
	...
	// 	create a new entry
	ph2_node_t* new_entry = add_child (node, address);
 ...
 */
static ph2_node_t* node_try_add (bool* added_new_node, ph2_node_t* node, hypercube_address_t address, ph2_point_t* point)
{
 ...
 */
static ph2_node_t* node_insert_split (ph2_node_t* parent, ph2_node_t* child, ph2_point_t* point, int max_conflicting_bits)
{
	/*
	...
	ph2_node_t* new_child = add_child (child, calculate_hypercube_address (&old_child.point, child));
 ...
 */
static ph2_node_t* node_handle_collision (ph2_node_t* node, ph2_node_t* sub_node, ph2_point_t* point)
{
	// if infix_length == 0
 ...
 */
static ph2_node_t* node_add (ph2_node_t* node, ph2_point_t* point)
{
	hypercube_address_t address = calculate_hypercube_address (point, node);
	...
	ph2_node_t* sub_node = node_try_add (&added_new_node, node, address, point);
...
void ph2_remove_child (ph2_node_t* node, hypercube_address_t address)
{
	int index = child_index (node, address);
