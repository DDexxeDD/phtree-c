...
#if defined (_MSC_VER)
#include <intrin.h>
uint64_t msvc32_5d_count_leading_zeoes (uint64_t bit_string)
{
...
uint64_t phtree32_5d_count_leading_zeroes (uint64_t bit_string)
{
	if (bit_string == 0)
	{
		return 64;
 ...
 */
uint64_t phtree32_5d_popcount (uint64_t bit_string)
{
...
#define count_leading_zeroes(bit_string) msvc32_5d_count_leading_zeoes (bit_string)
#define popcount __popcnt64
#else
#define count_leading_zeroes(bit_string) phtree32_5d_count_leading_zeroes (bit_string)
#define popcount phtree32_5d_popcount
#endif
