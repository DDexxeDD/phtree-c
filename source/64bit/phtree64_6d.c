...
#include "phtree64_6d.h"

#if defined (_MSC_VER)
#include <intrin.h>
uint64_t msvc64_6d_count_leading_zeoes (uint64_t bit_string)
{
...
uint64_t phtree64_6d_count_leading_zeroes (uint64_t bit_string)
{
	if (bit_string == 0)
	{
		return 64;
 ...
 */
uint64_t phtree64_6d_popcount (uint64_t bit_string)
{
...
#define count_leading_zeroes(bit_string) msvc64_6d_count_leading_zeoes (bit_string)
#define popcount __popcnt64
#else
#define count_leading_zeroes(bit_string) phtree64_6d_count_leading_zeroes (bit_string)
#define popcount phtree64_6d_popcount
#endif
...
void ph6_query_box_set (ph6_query_t* query, bool intersect, ph6_point_t* min_in, ph6_point_t* max_in, phtree_iteration_function_t function)
{
	...
	if (intersect)
	{
		...
		{
			max.values[iter] = PHTREE64_KEY_MAX;
		}
	}
