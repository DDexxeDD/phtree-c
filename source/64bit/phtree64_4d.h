 ...
 */
void* ph4_insert (ph4_t* tree, ph4_point_t* point, void* element);
/*
 ...
 */
void ph4_query_box_set (ph4_query_t* query, bool intersect, ph4_point_t* min, ph4_point_t* max, phtree_iteration_function_t function);
