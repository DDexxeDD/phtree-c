 ...
 */
void* ph2_insert (ph2_t* tree, ph2_point_t* point, void* element);
/*
 ...
 */
void ph2_query_box_set (ph2_query_t* query, bool intersect, ph2_point_t* min, ph2_point_t* max, phtree_iteration_function_t function);
